                ...
                <form action="" method="post">
                    <table class="table table-bordered text-center">
                        ...
                        <tr>
                            ...
                            <td>
  <button type="button" class="btn bg-info" onclick="updateQuantity(-1)">-</button>
  <input type="number" name="qty" id="qtyInput" class="form-input" value="$quantities" style="width: 50px; padding: 5px; margin: 0;">
  <button type="button" class="btn bg-info" onclick="updateQuantity(1)">+</button>
  
  <script>
    document.getElementById('qtyInput').value = $quantities;
